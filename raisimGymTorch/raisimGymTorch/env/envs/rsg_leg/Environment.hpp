...
public:
    explicit ENVIRONMENT(const std::string& resourceDir, const Yaml::Node& cfg, bool visualizable):
        ...
        //leg_ = world_->addArticulatedSystem(resourceDir_ + "/leg/leg1.urdf") ; //
        leg_ = world_->addArticulatedSystem(resourceDir_ + "/bolt_description/robots/bolt.urdf") ; //
        leg_->setName("leg");
...
//        no_collision_.push_back();
        ...
        //std::cout << "gc1111111: " << gc_ << std::endl;
...
//                    gv_.tail(12); // 12
        ...
        //bodyLinearPos_ =  gc_;
        //std::cout << "gc: " << gc_ << std::endl;
        //obDouble_ << gc_.tail(3), gv_.tail(3);
        ///////////////////////////////////
    }
